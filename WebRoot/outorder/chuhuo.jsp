				...
				.datagrid(
						{
							...
							//支持多条件查询
							url : '${proPath}/outorder/selectPageUseDyc.action',
													...
													.window(
															{
																...
																height : 400,
																modal : true,
																content : "<iframe src='${proPath}/base/goURL/outorder/update.action' height='100%' width='100%' frameborder='0px' ></iframe>"
															});
					...
					handler: function(){
						...
						parent.$.messager.confirm('删除对话框', '您确认要删除吗？', function(r) {
							if (r) {
								$.ajax({
								  url: "${proPath}/outorder/deleteList.action",
								  type:"POST",
								  //设置为传统方式传送参数
								  traditional:true,
								  data:{pks:ids},
					...
					handler: function(){
						...
						parent.$.messager.confirm('完成对话框', '您确认要完成吗？', function(r) {
							if (r) {
								alert(r);
								$.ajax({
								  url: "${proPath}/outorder/complete.action",
								  type:"POST",
								  //设置为传统方式传送参数
								  traditional:true,
								  data:{pks:ids},
										...
										.window(
												{
													...
													height : 600,
													modal : true,
													content : "<iframe src='${proPath}/base/goURL/outorder/selectg.action' height='100%' width='100%' frameborder='0px' ></iframe>"
												});
										...
										.window(
												{
													...
													height : 600,
													modal : true,
													content : "<iframe src='${proPath}/base/goURL/outorder/selects.action' height='100%' width='100%' frameborder='0px' ></iframe>"
												});
...
<body class="mybody">
	<form class="myfm" style="padding:15px;margin:0px;background:#eee;"
		id="ff" action="${proPath}/outorder/insert.action" method="post">
		<div class="myftitle">请填写出货信息</div>
		<div class="myfitem2">
		...
		<div class="myfitem2">
			<label>出货编号：</label><input type="text" id="orderId" name="orderId" />
			<label>出货时间：</label><input type="text" id="orderTime"
				name="orderTime" /> <label>备注：</label><input type="text"
				id="orderOk" name="orderOk" />
		</div>
		<div class="myfitem2">
			<input value="提交出货单" align="center" style="width:10%;" type="submit"
				name="sub">
		</div>
	</form>
